                                ...
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Area Comercial</li>
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="listarExiexportacionAComercial.php"> Listar Existencia Producto Terminado </a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                                    ...
                                                    <?php foreach ($ARRAYEXIEXPORTACION as $r) : ?>
                                                        <tr class="text-left">
                                                            ...
                                                            <td>
                                                                ...
                                                                if ($ARRAYEMBALAJE) {
                                                                    echo $ARRAYEMBALAJE[0]['NOMBRE_TEMBALAJE'];
                                                                } else {
                                                                    echo "Sin Embalaje";
                                                                }
                                                                ?>
