...
if ($EMPRESAS  && $TEMPORADAS) {
    ...
    $ARRAYDESPACHOINDTOTALES = $DESPACHOIND_ADO->obtenerTotalesDespachompEmpresaTemporadaCBX2($EMPRESAS,  $TEMPORADAS);
    $TOTALNETOIND = $ARRAYDESPACHOINDTOTALES[0]['NETO'];



    $TOTALNETO = $TOTALNETOIND;
}
                                            ...
                                            <tbody>
                                                <?php foreach ($ARRAYDESPACHOIND as $r) : ?>
                                                    ...
                                                    if ($r['TDESPACHO'] == "3") {
                                                        ...
                                                        if ($ARRAYCOMPRADOR) {
                                                            $ORIGEN = $ARRAYCOMPRADOR[0]['NOMBRE_COMPRADOR'];
                                                        } else {
                                                            $ORIGEN = "Sin Datos";
                                                        }
                                                    }
