...
if ($EMPRESAS  && $TEMPORADAS) {
    $ARRAYEXIINDUSTRIAL = $EXIINDUSTRIAL_ADO->listarExiindustrialEmpresaTemporadaDisponibleCBX($EMPRESAS,  $TEMPORADAS);
    $ARRAYTOTALEXIINDUSTRIAL = $EXIINDUSTRIAL_ADO->obtenerTotalesEmpresaTemporadaDisponible2($EMPRESAS,  $TEMPORADAS);
...
<head>
    <title>Detalaldo Existencia IND </title>
                                ...
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="#"> Detalaldo Existencia IND </a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 col-xs-12">
                                        <div class="table-responsive">
                                            <table id="existencia" class="table-hover " style="width: 100%;">
                                                <thead>
                                                    <tr class="text-left">
