...
if (isset($_REQUEST['AGREGAR'])) {
    if (isset($_REQUEST['SELECIONAREXISTENCIA'])) {
        $DESPACHOMP = $_REQUEST['DESPACHOMP'];
        ...
        foreach ($SELECIONAREXISTENCIA as $r) :
            ...
            $EXIMATERIAPRIMA->__SET('ID_DESPACHO', $DESPACHOMP);
...
if (isset($_REQUEST['EMPRESA']) && isset($_REQUEST['PLANTA']) && isset($_REQUEST['TEMPORADA'])  && isset($_REQUEST['DESPACHOMP'])) {
    ...
    $ARRAYEXIMATERIAPRIMA = $EXIMATERIAPRIMA_ADO->listarEximateriaprimaEmpresaPlantaTemporadaDisponible($EMPRESA, $PLANTA, $TEMPORADA);
