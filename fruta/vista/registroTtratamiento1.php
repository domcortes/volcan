...
include_once '../modelo/TTRATAMIENTO1.php';
...
if (isset($_SESSION['parametro']) && isset($_SESSION['parametro1'])) {
    ...
    if ($OP == "0") {
        ...
        $TTRATAMIENTO1->__SET('ID_TTRATAMIENTO', $IDOP);
                ...
                <div class="container-full">
                    ...
                    <div class="content-header">
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                <h3 class="page-title">Tipo Tratamiento 1</h3>
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="registroTtratamiento1.php">Operaciones Tipo Tratamiento 1 </a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
