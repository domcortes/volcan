...
if (isset($_REQUEST['AGREGAR'])) {
    ...
    $IDDESPACHOPT = $_REQUEST['IDDESPACHOPT'];
    ...
    if ($SINO == "0") {
        ...
        foreach ($SELECIONAREXISTENCIA as $r) :
            ...
            if ($SINO2 == "0") {
                ...
                $ARRAYVERPCDESPACHO = $DESPACHOPT_ADO->verDespachopt($IDDESPACHOPT);


                $EXIEXPORTACION->__SET('ID_DESPACHO', $IDDESPACHOPT);
                ...
                $EXIEXPORTACION_ADO->actualizarSelecionarDespacho2CambiarEstado($EXIEXPORTACION);
            }
...
if (isset($_REQUEST['EMPRESA']) && isset($_REQUEST['PLANTA']) && isset($_REQUEST['TEMPORADA']) && isset($_REQUEST['DESPACHOPT'])) {
    $EMPRESA = $_REQUEST['EMPRESA'];
    $PLANTA = $_REQUEST['PLANTA'];
    $TEMPORADA = $_REQUEST['TEMPORADA'];
    $IDDESPACHOPT = $_REQUEST['DESPACHOPT'];
    $ARRAYEXIEXPORTACION = $EXIEXPORTACION_ADO->buscarPorEmpresaPlantaTemporada($EMPRESA, $PLANTA, $TEMPORADA);
                ...
                <div class="box">
                    ...
                    <form class="form" role="form" method="post" name="form_reg_dato" id="form_reg_dato">
                        <div class="box-body ">
                            ...
                            <input type="hidden" id="IDDESPACHOPT" name="IDDESPACHOPT" value="<?php echo $IDDESPACHOPT; ?>" />
