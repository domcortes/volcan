                                                                    ...
                                                                    <div class="list-icons-item dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            ...
                                                                            <span href="#" class="dropdown-item" data-toggle="tooltip" title="Packing List">
                                                                                <button type="button" class="btn  btn-danger  btn-block" id="defecto" name="informe" title="Informe" Onclick="abrirPestana('../documento/informeNotadc.php?parametro=<?php echo $r['ID_DESPACHOEX']; ?>&&usuario=<?php echo $IDUSUARIOS; ?>'); ">
