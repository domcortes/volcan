    ...
    if ($SINO == "0") {
        ...
        foreach ($SELECIONAREXISTENCIA as $r) :
            ...
            if ($SINO2 == "0") {
                ...
                $EXIEXPORTACION->__SET('ID_INPSAG', $ID_INPSAG);
...
if (isset($_REQUEST['PLANTA']) && isset($_REQUEST['TEMPORADA']) && isset($_REQUEST['INPSAG'])) {

    $PLANTA = $_REQUEST['PLANTA'];
    $TEMPORADA = $_REQUEST['TEMPORADA'];
    $ID_INPSAG = $_REQUEST['INPSAG'];
    $ARRAYEXIEXPORTACION = $EXIEXPORTACION_ADO->buscarPorEmpresaPlantaTemporadaNoSag($PLANTA, $TEMPORADA);
                ...
                <div class="box">
                    ...
                    <form class="form" role="form" method="post" name="form_reg_dato" id="form_reg_dato">
                        <div class="box-body ">
                            ...
                            <input type="hidden" id="ID_INPSAG" name="ID_INPSAG" value="<?php echo $ID_INPSAG; ?>" />
