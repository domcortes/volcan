...
if (isset($_REQUEST['CREAR'])) {
    ...
    $DREXPORTACION->__SET('KILOS_NETO_DREXPORTACION', $_REQUEST['KILOSNETODRECEPCION']);
    $DREXPORTACION->__SET('PDESHIDRATACION_DREXPORTACION', $_REQUEST['PDESHIDRATACIONEESTANDAR']);
    $DREXPORTACION->__SET('KILOS_DESHIDRATACION_DREXPORTACION', $_REQUEST['KILOSDESHIDRATACION']);
    $DREXPORTACION->__SET('KILOS_BRUTO_DREXPORTACION', $_REQUEST['KILOSBRUTORECEPCION']);
