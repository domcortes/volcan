                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            ...
                                            <button type="button" class="btn btn-danger btn-outline btn-circle btn-sm" id="defecto" name="informe" title="Exportar PDF" Onclick="abrirVentana('../documento/informeCambiarFolioPT.php?NOMBREUSUARIO=<?php echo $NOMBREUSUARIOS; ?>&&EMPRESA=<?php echo $EMPRESAS; ?>&&PLANTA=<?php echo $PLANTAS; ?>&&TEMPORADA=<?php echo $TEMPORADAS; ?> '); ">
                                    ...
                                    <div class="col-sm-1">
                                        <div class="form-group">
                                            <label> </label>
                                            <button type="button" class="btn btn-success btn-outline btn-circle  btn-sm " id="defecto" name="reporte" title="Exportar Excel" Onclick="abrirVentana('../reporte/reporteCambiarFolioPt.php?EMPRESA=<?php echo $EMPRESAS; ?>&&PLANTA=<?php echo $PLANTAS; ?>&&TEMPORADA=<?php echo $TEMPORADAS; ?> '); ">
                                                                    ...
                                                                    <div class="list-icons d-inline-flex">
                                                                        <div class="list-icons-item dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                <button type="button" class="btn btn-rounded btn-sm btn-warning btn-outline " title="Cambiar Folio" id="CAMBIARFOLIO" name="CAMBIARFOLIO" Onclick="abrirVentana('cambiarFolioD.php?IDEXISTENCIA=<?php echo $r['ID_EXIEXPORTACION']; ?>'); ">
                                                                                    <i class="fa fa-exchange"></i>
                                                                                </button>Cambiar Folio
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
