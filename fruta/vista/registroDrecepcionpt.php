...
if (isset($_REQUEST['CREAR'])) {
    ...
    $EXIEXPORTACION->__SET('FECHA_COSECHA_EXIEXPORTACION', $_REQUEST['FECHACOSECHADRECEPCION']);
    $EXIEXPORTACION->__SET('CANTIDAD_ENVASE_EXIEXPORTACION', $_REQUEST['CANTIDADENVASEDRECEPCION']);
    $EXIEXPORTACION->__SET('KILOS_NETO_EXIEXPORTACION', $_REQUEST['KILOSNETODRECEPCION']);
    $EXIEXPORTACION->__SET('KILOS_BRUTO_EXIEXPORTACION', $_REQUEST['KILOSBRUTODRECEPCION']);
    $EXIEXPORTACION->__SET('KILOS_PROMEDIO_EXIEXPORTACION', $_REQUEST['KILOSPROMEDIODRECEPCION']);
    $EXIEXPORTACION->__SET('PESO_PALLET_EXIEXPORTACION', $_REQUEST['PESOPALLETRECEPCION']);
    $EXIEXPORTACION->__SET('ALIAS_DINAMICO_FOLIO_EXIEXPORTACION', $FOLIOALIASDIANAMICO);
    $EXIEXPORTACION->__SET('ALIAS_ESTATICO_FOLIO_EXIEXPORTACION', $FOLIOALIASESTACTICO);
