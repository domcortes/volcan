...
if (isset($_REQUEST['GUARDAR'])) {
    ...
    echo "<script type='text/javascript'> location.href ='registroLdestino.php';</script>";
}
...
if (isset($_SESSION['parametro']) && isset($_SESSION['parametro1'])) {
    ...
    if ($OP == "0") {
        ...
        $LDESTINO->__SET('ID_LDESTINO', $IDOP);
                ...
                <div class="container-full">
                    ...
                    <div class="content-header">
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                <h3 class="page-title">Lugar Destino</h3>
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="registroLdestino.php"> Operaciones Lugar Destino</a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                ...
                                <div class="box">
                                    ...
                                    <form class="form" role="form" method="post" name="form_reg_dato" onsubmit="return validacion()">
                                        ...
                                        <div class="box-footer">
                                            <button type="button" class="btn btn-rounded btn-warning btn-outline mr-1" name="CANCELAR" value="CANCELAR" Onclick="irPagina('registroLdestino.php'); ">
