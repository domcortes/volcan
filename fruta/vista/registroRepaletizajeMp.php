...
if (isset($_REQUEST['CREAR'])) {
    ...
    if ($SINO == "0") {
        ...
        echo "<script type='text/javascript'> location.href ='registroRepaletizajeMp.php?parametro=" . $ARRAYREPALETIZAJEBUSCARID[0]['ID_REPALETIZAJE'] . "&&parametro1=crear';</script>";
    }
}
...
if (isset($_REQUEST['GUARDAR'])) {
    ...
    if ($SINO == "0") {
        ...
        if ($_REQUEST['parametro1'] == "crear") {
            echo "<script type='text/javascript'> location.href ='registroRepaletizajeMp.php?parametro=" . $_REQUEST['ID'] . "&&parametro1=ver';</script>";
        }
...
if ($_POST) {
    ...
    if (isset($_REQUEST['FECHAINGRESOPALETIZAJE'])) {

        $FECHAINGRESOPALETIZAJE = "" . $_REQUEST['FECHAINGRESOPALETIZAJE'];
    }
    if (isset($_REQUEST['FECHAMODIFCIACIONRECEPCION'])) {

        $FECHAMODIFCIACIONPALETIZAJE = "" . $_REQUEST['FECHAMODIFCIACIONPALETIZAJE'];
    }
}
                                ...
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="registroRepaletizajeMp.php">Operaciones Repaletizaje Materia Prima</a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-10">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table id="salida" class="table  invoice-archive row-border hover order-column">
                                                                <thead>
                                                                    <tr>
                                                                        <th>
                                                                            <a href="#" class="text-warning hover-warning">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <?php if ($OP == "crear") { ?>
                                                            <button type=" button" class="btn btn-rounded btn-warning btn-outline mr-1" name="CANCELAR" value="CANCELAR" Onclick="irPagina('registroRepaletizajeMp.php');">
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($OP != "") { ?>
                                                            <button type="button" class="btn btn-rounded  btn-info btn-outline mr-1" id="defecto" name="tarjas" <?php echo $DISABLEDFOLIO;?> Onclick="abrirVentana('../documento/informeRepaletizajeMP.php?parametro=<?php echo $IDOP; ?>'); ">
