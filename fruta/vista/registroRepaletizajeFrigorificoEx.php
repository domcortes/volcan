...
if (isset($_REQUEST['CREAR'])) {
    ...
    if ($SINO == "0") {
        ...
        echo "<script type='text/javascript'> location.href ='registroRepaletizajeFrigorificoEx.php?parametro=" . $ARRAYREPALETIZAJEBUSCARID[0]['ID_REPALETIZAJE'] . "&&parametro1=crear';</script>";
    }
}
...
if (isset($_REQUEST['CERRAR'])) {
    ...
    if ($SINO == "0") {
        ...
        if ($_REQUEST['parametro1'] == "crear") {
            echo "<script type='text/javascript'> location.href ='registroRepaletizajeFrigorificoEx.php?parametro=" . $_REQUEST['ID'] . "&&parametro1=ver';</script>";
        }
                                ...
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="registroRepaletizajeFrigorificoEx.php">Operaciónes Repaletizaje </a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                        ...
                                        <!- detalle repaletizaje ->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                    <table>
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class=" center">
                                                                    <div class="form-group">
                                                                        <button type="button" class=" btn btn-rounded btn-success btn-outline" <?php echo $DISABLEDFOLIO; ?> <?php echo $DISABLED2; ?>  <?php if ($ESTADO == 0) {
                                                                                                                                                                                                                                                echo "disabled";
                                                    ...
                                                    <div class="form-group">
                                                        <label><b>Diferencia Envase</b> </label>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <?php if ($ESTADO == 0) { ?>
                                                            <?php if ($OP == "crear") { ?>
                                                                <button type="button" class="btn btn-rounded  btn-success btn-outline mr-1" name="CANCELAR" value="CANCELAR" Onclick="irPagina('listarRepaletizajeEx.php'); ">
                                                                    <i class="ti-back-left "></i> VOLVER
                                                                </button>
                                                            <?php } ?>

                                                            <?php if ($OP == "") { ?>
                                                                <button type="button" class="btn btn-rounded btn-warning btn-outline mr-1" name="CANCELAR" value="CANCELAR" Onclick="irPagina('registroRepaletizajeFrigorificoEx.php');">
