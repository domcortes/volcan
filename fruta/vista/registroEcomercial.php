...
include_once '../modelo/ECOMERCIAL.php';
...
if (isset($_REQUEST['GUARDAR'])) {
    ...
    echo "<script type='text/javascript'> location.href ='registroEcomercial.php';</script>";
}
...
if (isset($_SESSION['parametro']) && isset($_SESSION['parametro1'])) {
    ...
    if ($OP == "0") {
        ...
        $ECOMERCIAL->__SET('ID_ECOMERCIAL', $IDOP);
...
<head>
    <title>Registro Estandar Comercial</title>
                ...
                <div class="container-full">
                    ...
                    <div class="content-header">
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                <h3 class="page-title">Estandar Comercial</h3>
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="registroEcomercial.php"> Operaciones Estandar Comercial </a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                ...
                                -->
                                    ...
                                    <form class="form" role="form" method="post" name="form_reg_dato" onsubmit="return validacion()">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" step="0.01" class="form-control" placeholder="Peso Neto Estandar Comercial" id="PESONETOECOMERCIAL" name="PESONETOECOMERCIAL" value="<?php echo $PESONETOECOMERCIAL; ?>" <?php echo $DISABLED; ?> />
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" step="0.01"  class="form-control" placeholder="Peso Bruto Estandar Comercial" id="PESOBRUTOECOMERCIAL" name="PESOBRUTOECOMERCIAL" value="<?php echo $PESOBRUTOECOMERCIAL; ?>" <?php echo $DISABLED; ?> />
                                        ...
                                        <div class="box-footer">
                                            <button type="button" class="btn btn-rounded btn-warning btn-outline mr-1" name="CANCELAR" value="CANCELAR" Onclick="irPagina('registroEcomercial.php'); ">
