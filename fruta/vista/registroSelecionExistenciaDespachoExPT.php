    ...
    if ($SINO == "0") {
        ...
        foreach ($SELECIONAREXISTENCIA as $r) :
            ...
            if ($SINO2 == "0") {
                ...
                $ARRAYVERPCDESPACHO = $DESPACHOEX_ADO->verDespachoex($IDDESPACHOEX);

                $TOTALCAJAS = $ARRAYVERPCDESPACHO[0]['CANTIDAD_ENVASE_DESEXPORTACION'] + $ARRAYBUSCARNUMEROFOLIOEXIEXPORTACION[0]['CANTIDAD_ENVASE_EXIEXPORTACION'];
                $TOTALNETO = $ARRAYVERPCDESPACHO[0]['KILOS_NETO_DESEXPORTACION'] + $ARRAYBUSCARNUMEROFOLIOEXIEXPORTACION[0]['KILOS_NETO_EXIEXPORTACION'];
...
if (isset($_REQUEST['EMPRESA']) && isset($_REQUEST['PLANTA']) && isset($_REQUEST['TEMPORADA']) && isset($_REQUEST['DESPACHOEX'])) {
    ...
    $ARRAYEXIEXPORTACION = $EXIEXPORTACION_ADO->buscarPorEmpresaPlantaTemporadaDespacho($EMPRESA, $PLANTA, $TEMPORADA);
