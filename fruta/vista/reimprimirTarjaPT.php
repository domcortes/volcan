...
if (isset($_REQUEST['BUSCAR'])) {
    ...
    if ($SINO == "0") {
        $ARRAYEXISTENCIA1 = $EXIEXPORTACION_ADO->buscarPorFolioEmpresaPlantaTemporada($_REQUEST['NUMEROFOLIO'], $_REQUEST['EMPRESA'], $_REQUEST['PLANTA'], $_REQUEST['TEMPORADA']);
        $ARRAYEXISTENCIA2 = $EXIINDUSTRIAL_ADO->buscarPorFolioEmpresaPlantaTemporada($_REQUEST['NUMEROFOLIO'], $_REQUEST['EMPRESA'], $_REQUEST['PLANTA'], $_REQUEST['TEMPORADA']);

        if ($ARRAYEXISTENCIA1 || $ARRAYEXISTENCIA2) {
            $DISABLED = "";
                                ...
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="reimprimirTarjaPT.php"> Reimprimir Tarja </a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                    ...
                    <section class="content">
                        <div class="box">
                            <div class="box-header with-border">
                                <!--
                                        <h4 class="box-title">Producto Terminado</h4>
                                     -->
                            </div>
                                ...
                                <div class="box-body ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <button type="button" class="btn btn-rounded btn-danger btn-outline mr-1" name="PDF" value="PDF" title="Reimprimir" <?php echo $DISABLED; ?> Onclick="abrirVentana('../documento/tarjaPT.php?NUMEROFOLIO=<?php echo $NUMEROFOLIO; ?>&&EMPRESA=<?php echo $EMPRESA; ?>&&PLANTA=<?php echo $PLANTA; ?>&&TEMPORADA=<?php echo $TEMPORADA; ?>'); ">
