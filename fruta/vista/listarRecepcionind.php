...
if ($EMPRESAS  && $PLANTAS && $TEMPORADAS) {
    ...
    $ARRAYRECEPCION = $RECEPCIONIND_ADO->listarRecepcionEmpresaPlantaTemporada2CBX($EMPRESAS, $PLANTAS, $TEMPORADAS);
                                                                    ...
                                                                    <div class="list-icons-item dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-right">
                                                                            ...
                                                                            <span href="#" class="dropdown-item" data-toggle="tooltip" title="Informe">
                                                                                <button type="button" class="btn  btn-danger  btn-block" id="defecto" name="informe" title="Informe" Onclick="abrirPestana('../documento/informeRecepcionInd.php?parametro=<?php echo $r['ID_RECEPCION']; ?>&&usuario=<?php echo $IDUSUARIOS; ?>'); ">
                                                                                    <i class="fa fa-file-pdf-o"></i> Informe
                                                                                </button>
                                                                            </span>
                                                                            <span href="#" class="dropdown-item" data-toggle="tooltip" title="Tarjas">
                                                                                <button type="button" class="btn  btn-danger btn-block" id="defecto" name="tarjas" title="Tarjas" Onclick="abrirPestana('../documento/informeTarjasRecepcionInd.php?parametro=<?php echo $r['ID_RECEPCION']; ?>'); ">
