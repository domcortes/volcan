...
if ($EMPRESAS  && $PLANTAS && $TEMPORADAS) {
    ...
    $ARRAYRECEPCIONMPTOTALES = $RECEPCIONMP_ADO->obtenerTotalesRecepcionEmpresaPlantaTemporada2CBX($EMPRESAS, $PLANTAS, $TEMPORADAS);
    $TOTALBRUTO = $ARRAYRECEPCIONMPTOTALES[0]['BRUTO'];
    $TOTALNETO = $ARRAYRECEPCIONMPTOTALES[0]['NETO'];
    $TOTALENVASE = $ARRAYRECEPCIONMPTOTALES[0]['ENVASE'];
}
