...
if (isset($_REQUEST['AGREGAR'])) {
    if (isset($_REQUEST['SELECIONAREXISTENCIA'])) {
        ...
        foreach ($SELECIONAREXISTENCIA as $r) :
            ...
            $EXIMATERIAPRIMA->__SET('ID_DESPACHO2', $DESPACHOIND);
            ...
            $EXIMATERIAPRIMA_ADO->actualizarSelecionarDespachoIndCambiarEstado($EXIMATERIAPRIMA);
...
if (isset($_REQUEST['EMPRESA']) && isset($_REQUEST['PLANTA']) && isset($_REQUEST['TEMPORADA'])  && isset($_REQUEST['DESPACHOIND'])) {
    ...
    $ARRAYEXIMATERIAPRIMA = $EXIMATERIAPRIMA_ADO->listarEximateriaprimaDisponibleEmpresaPlantaTemporadaCBXTrecepcionIqf($EMPRESA, $PLANTA, $TEMPORADA);
