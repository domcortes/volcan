...
if ($EMPRESAS  && $PLANTAS && $TEMPORADAS) {
    $ARRAYEXIINDUSTRIAL1= $EXIINDUSTRIAL_ADO->listarExiindustrialEmpresaPlantaTemporadaDespachadoCBX($EMPRESAS, $PLANTAS, $TEMPORADAS);
    $ARRAYEXIINDUSTRIAL2 = $EXIINDUSTRIAL_ADO->listarExiindustrialRechazoMpEmpresaPlantaTemporadaDespachadoCBX($EMPRESAS, $PLANTAS, $TEMPORADAS);
    $ARRAYEXIINDUSTRIAL3 = $EXIINDUSTRIAL_ADO->listarExiindustrialRechazoPTEmpresaPlantaTemporadaDespachadoCBX($EMPRESAS, $PLANTAS, $TEMPORADAS);

    $ARRAYTOTALEXIINDUSTRIAL1 = $EXIINDUSTRIAL_ADO->obtenerTotalesEmpresaPlantaTemporadaDisponible($EMPRESAS, $PLANTAS, $TEMPORADAS);
    $ARRAYTOTALEXIINDUSTRIAL2 = $EXIINDUSTRIAL_ADO->obtenerTotalesRechazoMpEmpresaPlantaTemporadaDespachado($EMPRESAS, $PLANTAS, $TEMPORADAS);
    $ARRAYTOTALEXIINDUSTRIAL3 = $EXIINDUSTRIAL_ADO->obtenerTotalesRechazoPTEmpresaPlantaTemporadaDespachado($EMPRESAS, $PLANTAS, $TEMPORADAS);
    $TOTALNETO1 =  $ARRAYTOTALEXIINDUSTRIAL1[0]['NETO'];
    $TOTALNETO2 =  $ARRAYTOTALEXIINDUSTRIAL2[0]['NETO'];
    $TOTALNETO3 =  $ARRAYTOTALEXIINDUSTRIAL3[0]['NETO'];    
    $TOTALNETO  = number_format($TOTALNETO1 + $TOTALNETO2 + $TOTALNETO3, 2, ",", ".");
}
?>
