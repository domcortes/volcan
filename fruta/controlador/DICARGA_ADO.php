...
class DICARGA_ADO {
 ...
 //LISTAR TODO CON LIMITE DE 6 FILAS  
    ...
    public function agregarDicarga(DICARGA $DICARGA){
        try{
            ...
            "INSERT INTO `fruta_dicarga` 
                            (`CANTIDAD_ENVASE_DICARGA`, `KILOS_NETO_DICARGA`, `KILOS_BRUTO_DICARGA`, `PRECIO_US_DICARGA`, `TOTAL_PRECIO_US_DICARGA`, 
                             `ID_ESTANDAR`,  `ID_TCALIBRE`, `ID_ICARGA`,  `ESTADO`, `ESTADO_REGISTRO`) 
            VALUES
	       	(?, ?, ?, ?, ?, ?, ?, ?,  1, 1);";
    ...
    public function eliminarDicarga($id){
        try{$sql="DELETE FROM `fruta_dicarga` WHERE `ID_DICARGA`=".$id.";";
