...
<table border="0" cellspacing="0" cellpadding="0">
    <thead>
    <tr>   
        <th class="color left ">Folio Original</th>
        <th class="color left ">Folio Auxliar</th>
...
$NOMBREARCHIVO = "ReporteCambioFolioPT_";
...
$TIPOINFORME = "Reporte Existencia Cambio Folio PT ";
$CREADOR = "Usuario";
$AUTOR = "Usuario";
$ASUNTO = "Reporte";
$DESCRIPCION = "Reporte Existencia Cambio Folio PT Generado, " . $FECHANOMBRE . ", " . $HORAFINAL2;
$CATEGORIA = "Reporte";
$ETIQUETA = "Reporte PT";
