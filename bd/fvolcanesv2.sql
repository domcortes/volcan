...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-11-2021 a las 04:54:10
...
(1, 11111111, '1', 'empresa pruebas', 'Prueba Sistema', 'prueba empresa', '-', '1', '-', '', 1, '2021-07-20', '2021-11-22', 1, 1, 1),
...
--
ALTER TABLE `fruta_drecepcionpt`
  MODIFY `ID_DRECEPCION` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `fruta_exiexportacion`
  MODIFY `ID_EXIEXPORTACION` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
