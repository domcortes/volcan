...
$ARRAYINVENTARIOTOTALES = $INVENTARIOM_ADO->obtenerTotalesInventariot2CBX();
            ...
            <div class="container-full">
                ...
                <div class="content-header">
                    <div class="d-flex align-items-center">
                        <div class="mr-auto">
                            <h3 class="page-title">Inventario Materiales</h3>
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"> <a href="listarHInventariom.php"> Inventario Materiales </a>
                                        </li>
                                    </ol>
                                </nav>
                            </div>
