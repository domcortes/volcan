...
if (isset($_REQUEST['GUARDAR'])) {
    if (isset($_REQUEST['USUARIO'])) {
        ...
        if ($ARRAYRESPONSABLEUSUARIO) {
            $MENSAJE = "EL USUARIO SELECIONADO YA HA SIDO ASIGNADO";
            $SINO = "1";
        } else {
            $MENSAJE = "";
            $SINO = "0";
                                ...
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="registroResponsable.php"> Operaciónes Responsable </a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                ...
                                -->
                                    ...
                                    <form class="form" role="form" method="post" name="form_reg_dato" onsubmit="return validacion()">
                                        ...
                                        <div class="box-footer">
                                            <button type="button" class="btn btn-rounded btn-warning btn-outline mr-1" name="CANCELAR" value="CANCELAR" Onclick="irPagina('registroResponsable.php'); ">
