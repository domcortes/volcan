                                ...
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Tipo Usuario</li>
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="registroFpago.php"> Operaciónes Tipo Usuario </a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
