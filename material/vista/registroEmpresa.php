                                ...
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="registroEmpresa.php"> Operaciónes Empresa </a>
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                    ...
                                    <form class="form" role="form" method="post" name="form_reg_dato" onsubmit="return validacion()" enctype="multipart/form-data">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="file">
                                                    <input type="file" placeholder="IMG" id="LOGOEMPRESA" name="LOGOEMPRESA" values="<?php echo $LOGOEMPRESA; ?>" <?php echo $FOCUS2; ?> />
                                                </label>
                                                ...
                                                <?php } else { ?>
                                                    <img src="img/empresa/no_disponible.png" alt="Logo Empresa" class="rounded mx-auto d-block" style="max-width:100px; max-height:100px;width: auto;height: auto;">
                                                <?php } ?>
                                        ...
                                        <div class="box-footer">
                                            <button type="button" class="btn btn-rounded btn-warning btn-outline mr-1" name="CANCELAR" value="CANCELAR" Onclick="irPagina('registroEmpresa.php'); ">
