...
if (isset($_REQUEST['AGREGAR'])) {
    ...
    if (isset($_REQUEST['SELECIONAREXISTENCIA'])) {
        ...
        foreach ($SELECIONAREXISTENCIA as $r) :
            ...
            $INVENTARIOE->__SET('ID_DESPACHO', $IDDESPACHO);
            $INVENTARIOE->__SET('ID_INVENTARIO', $IDEXISMATERIAPRIMA);
            //LLAMADA AL METODO DE REGISTRO DEL CONTROLADOR
         //   $INVENTARIOE_ADO->actualizarSelecionarDespachoCambiarEstado($INVENTARIOE);
        endforeach;       
        /* 
