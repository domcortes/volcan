...
if (
    ...
    foreach ($ARRAYDRECEPCION as $r) :
        ...
        $ESTADO = "" . $r['ESTADO'];
        $CANTIDADPT = $CANTIDADT - $CANTIDADC;
    endforeach;
}
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <?php if ($ESTADO == 0) { ?>
                                                        <?php if ($OP == "crear") { ?>
                                                            <button type="button" class="btn btn-rounded btn-success btn-outline " name="CANCELAR" value="CANCELAR" Onclick="irPagina('<?php echo $URLD; ?>.php?op');">
