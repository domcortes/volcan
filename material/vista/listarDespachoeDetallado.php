...
if ($EMPRESAS  && $PLANTAS && $TEMPORADAS) {
    ...
    $ARRAYDESPACHOPT = $DESPACHOE_ADO->listarDespachoeEmpresaPlantaTemporadaCBX2($EMPRESAS, $PLANTAS, $TEMPORADAS);
                                        ...
                                        <table id="modulo" class="table table-hover " style="width: 100%;">
                                            ...
                                            <tbody>
                                                <?php foreach ($ARRAYDESPACHOPT as $r) : ?>
                                                    ...
                                                    $ARRAYTOMADO = $INVENTARIOE_ADO->buscarPorDespacho2($r['ID_DESPACHO']);
                                                    ?>
