                            ...
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"> <a href="listarInventariomDespacho.php"> Inventario Materiales </a>
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-1 col-1">
                                                <div class="form-group">
                                                    ...
                                                    <br>
                                                    <input type="hidden" class="form-control" placeholder="URLEXCEL" id="URLEXCEL" name="URLEXCEL" value="reporteInventariom" />
