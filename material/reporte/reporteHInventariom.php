...
$ARRAYINVENTARIO = $INVENTARIOM_ADO->listarInventariot2CBX();
...
<table border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>   
        ...
        <th class="color center ">Tipo Contenedor </th>
...
foreach ($ARRAYINVENTARIO as $r) :
    ...
    $ARRAYVERTCONTENEDOR = $TCONTENEDOR_ADO->verTcontenedor($r['ID_TCONTENEDOR']);
    $ARRAYVERTUMEDIDA = $TUMEDIDA_ADO->verTumedida($r['ID_TUMEDIDA']);
    $ARRAYEMPRESA =  $EMPRESA_ADO->verEmpresa($r['ID_EMPRESA']);
    $ARRAYPLANTA =  $PLANTA_ADO->verplanta($r['ID_EMPRESA']);
    ...
    $html = $html . '    
            <tr class="center">
                ...
                <td class="center">   ' . $ARRAYVERTCONTENEDOR[0]['NOMBRE_TCONTENEDOR'] . '</td>
...
$NOMBREARCHIVO = "ReporteHistorialInventario_";
...
$TIPOINFORME = "Reporte Historial Inventario ";
$CREADOR = "Usuario";
$AUTOR = "Usuario";
$ASUNTO = "Reporte";
$DESCRIPCION = "Reporte Historial Inventario Generado, " . $FECHANOMBRE . ", " . $HORAFINAL2;
$CATEGORIA = "Reporte";
$ETIQUETA = "Reporte Historial Envases";
