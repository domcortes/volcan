 ...
 //LISTAR TODO CON LIMITE DE 6 FILAS   
    ...
    public function listarMguiaDespachoCBX($DESPACHO){
        try{
            ...
            $datos=$this->conexion->prepare("SELECT * FROM fruta_mguiapt 
    ...
    public function listarMguiaCBX2(){
        try{
    ...
    public function agregarMguia(MGUIAPT $MGUIAPT){
        try{
            
            
            $query=
            "INSERT INTO fruta_mguiapt ( 
                                            NUMERO_MGUIA,
                                            NUMERO_DESPACHO, 
                                            NUMERO_GUIA, 
                                            MOTIVO_MGUIA, 
            ...
            ->execute(
                array(
                    ...
                    $MGUIAPT->__GET('NUMERO_MGUIA'),
                    $MGUIAPT->__GET('NUMERO_DESPACHO'),
                    $MGUIAPT->__GET('NUMERO_GUIA'),
                    $MGUIAPT->__GET('MOTIVO_MGUIA'),
                    $MGUIAPT->__GET('ID_DESPACHO'),
                    $MGUIAPT->__GET('ID_PLANTA2'),
                    $MGUIAPT->__GET('ID_EMPRESA'),
                    $MGUIAPT->__GET('ID_PLANTA'),
                    $MGUIAPT->__GET('ID_TEMPORADA'),
                    $MGUIAPT->__GET('ID_USUARIOI'),
                    $MGUIAPT->__GET('ID_USUARIOM')                   
    ...
    public function eliminarMguia($id){
        try{$sql="DELETE FROM fruta_mguiapt WHERE ID_MGUIA=".$id.";";
    ...
    public function actualizarMguia(MGUIAPT $MGUIAPT){
        try{
            $query = "
		UPDATE fruta_mguiapt SET
            NUMERO_DESPACHO= ?,
            NUMERO_GUIA= ?,
            MOTIVO_MGUIA= ?,
            ID_DESPACHO= ?,
    ...
    public function deshabilitar(MGUIAPT $MGUIAPT){
    ...
    //CAMBIO A ACTIVADO
    public function habilitar(MGUIAPT $MGUIAPT){
        try{
            $query = "
    UPDATE fruta_mguiapt SET			
            ESTADO_REGISTRO = 1
    ...
    public function listarMguiaEmpresaPlantaTemporadaCBX($EMPRESA, $PLANTA, $TEMPORADA){
        try{
    ...
    public function listarMguiaEmpresaPlantaTemporadaDespachoDestinoCBX($DESPACHO, $EMPRESA, $PLANTA, $TEMPORADA){
        try{
